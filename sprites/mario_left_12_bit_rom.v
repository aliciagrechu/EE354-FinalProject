module mario_left_rom
	...
	always @(*) begin
		...
		if(({row_reg, col_reg}>=8'b01111100) && ({row_reg, col_reg}<8'b10000100)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=8'b10001101) && ({row_reg, col_reg}<8'b10010011)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b10010011) && ({row_reg, col_reg}<8'b10010111)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}>=8'b10100100) && ({row_reg, col_reg}<8'b10100110)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}==8'b11000011)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=8'b11101011) && ({row_reg, col_reg}<8'b11110100)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11110100) && ({row_reg, col_reg}<8'b11110111)) color_data = 12'b011000110011;
