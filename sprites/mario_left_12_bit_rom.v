module mario_left_rom
	...
	always @(*) begin
		...
		if(({row_reg, col_reg}>=10'b0111111000) && ({row_reg, col_reg}<10'b1000001000)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=10'b1000011010) && ({row_reg, col_reg}<10'b1000101000)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=10'b1000111010) && ({row_reg, col_reg}<10'b1001000110)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1001000110) && ({row_reg, col_reg}<10'b1001001110)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}>=10'b1001011100) && ({row_reg, col_reg}<10'b1001100110)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1001100110) && ({row_reg, col_reg}<10'b1001101110)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}>=10'b1010001000) && ({row_reg, col_reg}<10'b1010001100)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}>=10'b1010101000) && ({row_reg, col_reg}<10'b1010101100)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}>=10'b1100000110) && ({row_reg, col_reg}<10'b1100001000)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=10'b1100011100) && ({row_reg, col_reg}<10'b1100100110)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1100100110) && ({row_reg, col_reg}<10'b1100101000)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=10'b1110110110) && ({row_reg, col_reg}<10'b1111001000)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1111001000) && ({row_reg, col_reg}<10'b1111001110)) color_data = 12'b011000110011;
		...
		if(({row_reg, col_reg}>=10'b1111010110) && ({row_reg, col_reg}<10'b1111101000)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1111101000) && ({row_reg, col_reg}<10'b1111101110)) color_data = 12'b011000110011;
