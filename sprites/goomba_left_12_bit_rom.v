module goomba_left_rom
	...
	always @(*) begin
		...
		if(({row_reg, col_reg}>=8'b10101110) && ({row_reg, col_reg}<8'b10110010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b10110010) && ({row_reg, col_reg}<8'b10110100)) color_data = 12'b010000100001;
		if(({row_reg, col_reg}>=8'b10110100) && ({row_reg, col_reg}<8'b10111100)) color_data = 12'b111111001011;

		if(({row_reg, col_reg}>=8'b10111100) && ({row_reg, col_reg}<8'b11000001)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11000001) && ({row_reg, col_reg}<8'b11000101)) color_data = 12'b010000100001;
		if(({row_reg, col_reg}>=8'b11000101) && ({row_reg, col_reg}<8'b11001011)) color_data = 12'b111111001011;
		if(({row_reg, col_reg}>=8'b11001011) && ({row_reg, col_reg}<8'b11001101)) color_data = 12'b010000100001;

		if(({row_reg, col_reg}>=8'b11001101) && ({row_reg, col_reg}<8'b11010001)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11010001) && ({row_reg, col_reg}<8'b11010110)) color_data = 12'b010000100001;
		if(({row_reg, col_reg}>=8'b11010110) && ({row_reg, col_reg}<8'b11011010)) color_data = 12'b111111001011;
		if(({row_reg, col_reg}>=8'b11011010) && ({row_reg, col_reg}<8'b11011101)) color_data = 12'b010000100001;

		if(({row_reg, col_reg}>=8'b11011101) && ({row_reg, col_reg}<8'b11100010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11100010) && ({row_reg, col_reg}<8'b11100111)) color_data = 12'b010000100001;
		if(({row_reg, col_reg}>=8'b11100111) && ({row_reg, col_reg}<8'b11101001)) color_data = 12'b111111001011;
		if(({row_reg, col_reg}>=8'b11101001) && ({row_reg, col_reg}<8'b11101100)) color_data = 12'b010000100001;

		if(({row_reg, col_reg}>=8'b11101100) && ({row_reg, col_reg}<8'b11110011)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11110011) && ({row_reg, col_reg}<8'b11110111)) color_data = 12'b010000100001;
		if(({row_reg, col_reg}==8'b11110111)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11111000) && ({row_reg, col_reg}<8'b11111011)) color_data = 12'b010000100001;
