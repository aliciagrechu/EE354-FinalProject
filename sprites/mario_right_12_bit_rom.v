module mario_right_rom
	...
	always @(*) begin
		...
		if(({row_reg, col_reg}>=8'b10001100) && ({row_reg, col_reg}<8'b10010010)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=8'b10011001) && ({row_reg, col_reg}<8'b10011101)) color_data = 12'b110000100000;

		if(({row_reg, col_reg}>=8'b10011101) && ({row_reg, col_reg}<8'b10100010)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=8'b10101010) && ({row_reg, col_reg}<8'b10101100)) color_data = 12'b110000100000;
		...
		if(({row_reg, col_reg}>=8'b10110101) && ({row_reg, col_reg}<8'b10111011)) color_data = 12'b000000001101;
		if(({row_reg, col_reg}>=8'b10111011) && ({row_reg, col_reg}<8'b10111110)) color_data = 12'b110110100110;

		if(({row_reg, col_reg}>=8'b10111110) && ({row_reg, col_reg}<8'b11000010)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}==8'b11001100)) color_data = 12'b110110100110;

		if(({row_reg, col_reg}>=8'b11001101) && ({row_reg, col_reg}<8'b11010101)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11010101) && ({row_reg, col_reg}<8'b11010111)) color_data = 12'b000000001101;
		if(({row_reg, col_reg}>=8'b11010111) && ({row_reg, col_reg}<8'b11011001)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=8'b11011001) && ({row_reg, col_reg}<8'b11011011)) color_data = 12'b000000001101;
		...
		if(({row_reg, col_reg}>=8'b11101011) && ({row_reg, col_reg}<8'b11110101)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=8'b11111001) && ({row_reg, col_reg}<8'b11111100)) color_data = 12'b011000110011;

		if(({row_reg, col_reg}>=8'b11111100) && ({row_reg, col_reg}<=8'b11111111)) color_data = 12'b000000000000;
	end
endmodule