module mario_walk_right_rom
	...
	always @(*) begin
		...
		if(({row_reg, col_reg}>=10'b1000011000) && ({row_reg, col_reg}<10'b1000011010)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=10'b1000111000) && ({row_reg, col_reg}<10'b1000111010)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=10'b1001010010) && ({row_reg, col_reg}<10'b1001010110)) color_data = 12'b110000100000;
		if(({row_reg, col_reg}>=10'b1001010110) && ({row_reg, col_reg}<10'b1001011100)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=10'b1001110010) && ({row_reg, col_reg}<10'b1001110110)) color_data = 12'b110000100000;
		if(({row_reg, col_reg}>=10'b1001110110) && ({row_reg, col_reg}<10'b1001111100)) color_data = 12'b110110100110;
		...
		if(({row_reg, col_reg}>=10'b1010010100) && ({row_reg, col_reg}<10'b1010010110)) color_data = 12'b110000100000;
		if(({row_reg, col_reg}>=10'b1010010110) && ({row_reg, col_reg}<10'b1010011010)) color_data = 12'b110110100110;

		if(({row_reg, col_reg}>=10'b1010011010) && ({row_reg, col_reg}<10'b1010100100)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=10'b1010110100) && ({row_reg, col_reg}<10'b1010110110)) color_data = 12'b110000100000;
		if(({row_reg, col_reg}>=10'b1010110110) && ({row_reg, col_reg}<10'b1010111010)) color_data = 12'b110110100110;

		if(({row_reg, col_reg}>=10'b1010111010) && ({row_reg, col_reg}<10'b1011000100)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1011000100) && ({row_reg, col_reg}<10'b1011001010)) color_data = 12'b110110100110;
		if(({row_reg, col_reg}>=10'b1011001010) && ({row_reg, col_reg}<10'b1011010100)) color_data = 12'b000000001101;

		if(({row_reg, col_reg}>=10'b1011010100) && ({row_reg, col_reg}<10'b1011100100)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1011100100) && ({row_reg, col_reg}<10'b1011101010)) color_data = 12'b110110100110;
		if(({row_reg, col_reg}>=10'b1011101010) && ({row_reg, col_reg}<10'b1011110100)) color_data = 12'b000000001101;

		if(({row_reg, col_reg}>=10'b1011110100) && ({row_reg, col_reg}<10'b1100000100)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=10'b1100010110) && ({row_reg, col_reg}<10'b1100100100)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=10'b1100110110) && ({row_reg, col_reg}<10'b1101001010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1101001010) && ({row_reg, col_reg}<10'b1101010000)) color_data = 12'b000000001101;
		if(({row_reg, col_reg}>=10'b1101010000) && ({row_reg, col_reg}<10'b1101010010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1101010010) && ({row_reg, col_reg}<10'b1101010110)) color_data = 12'b011000110011;

		if(({row_reg, col_reg}>=10'b1101010110) && ({row_reg, col_reg}<10'b1101101010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1101101010) && ({row_reg, col_reg}<10'b1101110000)) color_data = 12'b000000001101;
		if(({row_reg, col_reg}>=10'b1101110000) && ({row_reg, col_reg}<10'b1101110010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1101110010) && ({row_reg, col_reg}<10'b1101110110)) color_data = 12'b011000110011;
		...
		if(({row_reg, col_reg}>=10'b1110010010) && ({row_reg, col_reg}<10'b1110011000)) color_data = 12'b011000110011;

		if(({row_reg, col_reg}>=10'b1110011000) && ({row_reg, col_reg}<10'b1110101010)) color_data = 12'b000000000000;
		...
		if(({row_reg, col_reg}>=10'b1110110010) && ({row_reg, col_reg}<10'b1110111000)) color_data = 12'b011000110011;

		if(({row_reg, col_reg}>=10'b1110111000) && ({row_reg, col_reg}<10'b1111001010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1111001010) && ({row_reg, col_reg}<10'b1111010000)) color_data = 12'b011000110011;

		if(({row_reg, col_reg}>=10'b1111010000) && ({row_reg, col_reg}<10'b1111101010)) color_data = 12'b000000000000;
		if(({row_reg, col_reg}>=10'b1111101010) && ({row_reg, col_reg}<10'b1111110000)) color_data = 12'b011000110011;

		if(({row_reg, col_reg}>=10'b1111110000) && ({row_reg, col_reg}<=10'b1111111111)) color_data = 12'b000000000000;
	end
endmodule